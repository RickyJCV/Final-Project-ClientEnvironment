	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-6">
				...
				<input type="radio" id="Daniel" name="color" value="Daniel">
				  <label for="Daniel">Daniel</label><br>

				  <input type="radio" id="Pablo" name="color" value="Pablo">
				  <label for="Pablo">Pablo</label><br>

				  <input type="radio" id="Ricardo" name="color" value="Ricardo">
				  <label for="Ricardo">Ricardo</label><br>

				<!--
				<input type="checkbox" id="Daniel" value="roja"><b>Daniel</b><br>
				<input type="checkbox" id="Pablo" value="Pablo"><b>Pablo</b><br>
				<input type="checkbox" id="Ricardo" value="Ricardo"><b>Ricardo</b><br>
